...
namespace MobageEditor
{
	public class JsonMapper
	{
		...
		private static void RegisterBaseExporters()
		{
			...
			{
				writer.Write(System.Convert.ToInt32((byte)obj));
			};
			base_exporters_table[typeof(char)] = delegate(object obj, JsonWriter writer)
			{
				writer.Write(System.Convert.ToString((char)obj));
			};
			base_exporters_table[typeof(DateTime)] = delegate(object obj, JsonWriter writer)
			{
				writer.Write(System.Convert.ToString((DateTime)obj, datetime_format));
			};
