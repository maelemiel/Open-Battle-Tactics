	...
	internal class InternalStaticBatchingUtility
	{
		...
		public static void Combine(GameObject[] gos, GameObject staticBatchRoot)
		{
			...
			foreach (GameObject gameObject in gos)
			{
				...
				if (meshFilter == null || meshFilter.sharedMesh == null || !meshFilter.sharedMesh.canAccess || meshFilter.renderer == null || !meshFilter.renderer.enabled || meshFilter.renderer.staticBatchIndex != 0)
				{
					continue;
				}
				...
				{
					Debug.LogWarning("Mesh has more materials (" + array.Length + ") than subsets (" + sharedMesh.subMeshCount + ")");
