...
namespace Mono.Math
{
	public class BigInteger
	{
		...
		internal sealed class Montgomery
		{
			...
			{
				//IL_0021->IL002d: Incompatible stack types: I vs Ref
				//IL_004d->IL0059: Incompatible stack types: I vs Ref
				fixed (uint* ptr = &(n.data != null && n.data.Length != 0 ? ref n.data[0] : ref *(uint*)null))
				{
					fixed (uint* ptr2 = &(m.data != null && m.data.Length != 0 ? ref m.data[0] : ref *(uint*)null))
					{
						for (uint num = 0u; num < m.length; num++)
						{
							...
							uint* ptr4 = ptr;
							uint* ptr5 = ptr;
							ulong num3 = (ulong)((long)num2 * (long)(*(ptr3++)) + *(ptr4++));
							num3 >>= 32;
							uint num4;
							for (num4 = 1u; num4 < m.length; num4++)
							{
								num3 += (ulong)((long)num2 * (long)(*(ptr3++)) + *(ptr4++));
								*(ptr5++) = (uint)num3;
								num3 >>= 32;
							}
							for (; num4 < n.length; num4++)
							{
								num3 += *(ptr4++);
								*(ptr5++) = (uint)num3;
								num3 >>= 32;
		...
		private sealed class Kernel
		{
			...
			public unsafe static void Multiply(uint[] x, uint xOffset, uint xLen, uint[] y, uint yOffset, uint yLen, uint[] d, uint dOffset)
			{
				...
				//IL_0032->IL0039: Incompatible stack types: I vs Ref
				//IL_0051->IL0059: Incompatible stack types: I vs Ref
				fixed (uint* ptr = &(x != null && x.Length != 0 ? ref x[0] : ref *(uint*)null))
				{
					fixed (uint* ptr2 = &(y != null && y.Length != 0 ? ref y[0] : ref *(uint*)null))
					{
						fixed (uint* ptr3 = &(d != null && d.Length != 0 ? ref d[0] : ref *(uint*)null))
						{
			...
			public unsafe static void MultiplyMod2p32pmod(uint[] x, int xOffset, int xLen, uint[] y, int yOffest, int yLen, uint[] d, int dOffset, int mod)
			{
				...
				fixed (uint* ptr = &(x != null && x.Length != 0 ? ref x[0] : ref *(uint*)null))
				{
					fixed (uint* ptr2 = &(y != null && y.Length != 0 ? ref y[0] : ref *(uint*)null))
					{
						fixed (uint* ptr3 = &(d != null && d.Length != 0 ? ref d[0] : ref *(uint*)null))
						{
							uint* ptr4 = (uint*)((byte*)ptr + xOffset * 4);
							uint* ptr5 = (uint*)((byte*)ptr4 + xLen * 4);
							uint* ptr6 = (uint*)((byte*)ptr2 + yOffest * 4);
							uint* ptr7 = (uint*)((byte*)ptr6 + yLen * 4);
							uint* ptr8 = (uint*)((byte*)ptr3 + dOffset * 4);
			...
			{
				//IL_0035->IL003c: Incompatible stack types: I vs Ref
				//IL_0052->IL0059: Incompatible stack types: I vs Ref
				uint[] array = wkSpace;
				wkSpace = bi.data;
				uint[] data = bi.data;
				uint length = bi.length;
				bi.data = array;
				fixed (uint* ptr = &(data != null && data.Length != 0 ? ref data[0] : ref *(uint*)null))
				{
					fixed (uint* ptr2 = &(array != null && array.Length != 0 ? ref array[0] : ref *(uint*)null))
					{
						uint* ptr3 = (uint*)((byte*)ptr2 + array.Length * 4);
