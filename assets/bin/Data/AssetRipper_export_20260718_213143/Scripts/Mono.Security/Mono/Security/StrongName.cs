...
namespace Mono.Security
{
	public sealed class StrongName
	{
		...
		internal StrongNameSignature StrongHash(Stream stream, StrongNameOptions options)
		{
			...
			if (Mono.Security.BitConverterLE.ToUInt16(array, 0) != 23117)
			{
				return null;
			}
			uint num = Mono.Security.BitConverterLE.ToUInt32(array, 60);
			...
			if (Mono.Security.BitConverterLE.ToUInt32(array3, 0) != 17744)
			{
				return null;
			}
			if (Mono.Security.BitConverterLE.ToUInt16(array3, 4) != 332)
			{
				return null;
			}
			byte[] src = new byte[8];
			...
			ushort num2 = Mono.Security.BitConverterLE.ToUInt16(array3, 6);
			int num3 = num2 * 40;
			byte[] array4 = new byte[num3];
			stream.Read(array4, 0, num3);
			cryptoStream.Write(array4, 0, num3);
			uint r = Mono.Security.BitConverterLE.ToUInt32(array3, 232);
			uint num4 = RVAtoPosition(r, num2, array4);
			int num5 = (int)Mono.Security.BitConverterLE.ToUInt32(array3, 236);
			byte[] array5 = new byte[num5];
			stream.Position = num4;
			stream.Read(array5, 0, num5);
			uint r2 = Mono.Security.BitConverterLE.ToUInt32(array5, 32);
			strongNameSignature.SignaturePosition = RVAtoPosition(r2, num2, array4);
			strongNameSignature.SignatureLength = Mono.Security.BitConverterLE.ToUInt32(array5, 36);
			uint r3 = Mono.Security.BitConverterLE.ToUInt32(array5, 8);
			strongNameSignature.MetadataPosition = RVAtoPosition(r3, num2, array4);
			strongNameSignature.MetadataLength = Mono.Security.BitConverterLE.ToUInt32(array5, 12);
			...
			{
				uint num6 = Mono.Security.BitConverterLE.ToUInt32(array4, i * 40 + 20);
				int num7 = (int)Mono.Security.BitConverterLE.ToUInt32(array4, i * 40 + 16);
