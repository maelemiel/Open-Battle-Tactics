...
namespace System.Runtime.Remoting
{
	internal class SingleCallIdentity : ServerIdentity
	{
		...
		{
			MarshalByRefObject marshalByRefObject = (MarshalByRefObject)Activator.CreateInstance(_objectType, true);
			if (marshalByRefObject.ObjectIdentity == null)
			{
				marshalByRefObject.ObjectIdentity = this;
			}
			IMessageSink messageSink = _context.CreateServerObjectSinkChain(marshalByRefObject, false);
