namespace System.Runtime.InteropServices.ComTypes
{
	...
	public interface ITypeInfo2 : ITypeInfo
	{
		...
		new void GetIDsOfNames([In][MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr, SizeConst = 0, SizeParamIndex = 1)] string[] rgszNames, int cNames, [Out][MarshalAs(UnmanagedType.LPArray, SizeConst = 0, SizeParamIndex = 1)] int[] pMemId);
		...
		new void GetNames(int memid, [Out][MarshalAs(UnmanagedType.LPArray, SizeConst = 0, SizeParamIndex = 2)] string[] rgBstrNames, int cMaxNames, out int pcNames);
