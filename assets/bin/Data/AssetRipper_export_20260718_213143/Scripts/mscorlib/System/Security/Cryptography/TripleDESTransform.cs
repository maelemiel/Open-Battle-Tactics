...
namespace System.Security.Cryptography
{
	internal class TripleDESTransform : SymmetricTransform
	{
			...
			: base(algo, encryption, iv)
		{
			...
			{
				E1 = new DESTransform(symmAlgo, true, array, iv);
				D2 = new DESTransform(symmAlgo, false, array2, iv);
				E3 = new DESTransform(symmAlgo, true, array3, iv);
			}
			else
			{
				D1 = new DESTransform(symmAlgo, false, array3, iv);
				E2 = new DESTransform(symmAlgo, true, array2, iv);
				D3 = new DESTransform(symmAlgo, false, array, iv);
			}
		}
