...
namespace System.Globalization
{
	...
	public class JapaneseCalendar : Calendar
	{
		...
		{
			M_AbbrEraNames = new string[4] { "M", "T", "S", "H" };
			M_EraNames = new string[4] { "Meiji", "Taisho", "Showa", "Heisei" };
		}

		static JapaneseCalendar()
		{
			JapanMin = new DateTime(1868, 9, 8, 0, 0, 0);
			JapanMax = new DateTime(9999, 12, 31, 11, 59, 59);
			...
			M_EraHandler.appendEra(4, CCGregorianCalendar.fixed_from_dmy(8, 1, 1989));
		}
