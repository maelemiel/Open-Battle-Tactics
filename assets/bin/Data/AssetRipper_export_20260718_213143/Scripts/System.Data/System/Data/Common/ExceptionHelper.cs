...
namespace System.Data.Common
{
	internal sealed class ExceptionHelper
	{
		...
		{
			string[] args = new string[1] { value.ToString() };
		...
		{
			string message = string.Format(CultureInfo.InvariantCulture, "The {0} enumeration value, {1}, is invalid.", enumeration, value);
			return new ArgumentOutOfRangeException(enumeration, message);
		}
		...
		{
			string[] args = new string[1] { mehodName };
		...
		{
			string[] args = new string[2] { type1, type2 };
			return new ArgumentException(GetExceptionMessage("No mapping exists from DbType {0} to a known {1}.", args));
		}
		...
		{
			return new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "This {0} has completed; it is no longer usable.", type.Name));
		}
		...
		{
			object[] args = new object[3] { parameterPosition, parameterName, parameterType };
		...
		{
			string[] args = new string[1] { provider };
		...
		{
			object[] args = new object[2] { operationName, connectionState };
		...
		{
			object[] args = new object[1] { methodName };
		...
		{
			object[] args = new object[2] { methodName, connectionState };
			return new InvalidOperationException(GetExceptionMessage("{0} requires an open and available Connection. The connection's current state is {1}.", args));
		}
		...
		{
			object[] args = new object[1] { connectionState };
		...
		{
			object[] args = new object[2] { propertyName, connectionState };
		...
		{
			object[] args = new object[1] { command };
