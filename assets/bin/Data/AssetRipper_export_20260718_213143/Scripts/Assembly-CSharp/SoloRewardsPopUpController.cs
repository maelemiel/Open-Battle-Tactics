...
public class SoloRewardsPopUpController : PopupController
{
	[SerializeField]
	...
	public void UpdateRewardsPopUp()
	{
		...
		if ((bool)_title)
		{
			_title.text = "ui_leaderboard_solo_rewards_title".Localize("YOUR REWARDS");
			_addRewardsTitle.text = "ui_leaderboard_solo_rewards_text01".Localize("ADDITONAL PRIZES");
		}
