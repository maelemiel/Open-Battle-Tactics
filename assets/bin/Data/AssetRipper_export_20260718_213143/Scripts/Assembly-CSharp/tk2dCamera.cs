...
public class tk2dCamera : MonoBehaviour
{
	...
	public static float ScreenWidth
	{
		get
		{
			return Instance.ScreenExtents.width;
		}
	}
	...
	public static float ScreenHeight
	{
		get
		{
			return Instance.ScreenExtents.height;
		}
	}
	...
	public tk2dCameraResolutionOverride CurrentResolutionOverride
	{
		get
		{
			...
			if (tk2dCameraResolutionOverride2 == null || (tk2dCameraResolutionOverride2 != null && ((float)tk2dCameraResolutionOverride2.width != pixelWidth || (float)tk2dCameraResolutionOverride2.height != pixelHeight)))
			{
				...
				if (settingsRoot.resolutionOverride != null)
				{
					...
					{
						if (tk2dCameraResolutionOverride3.Match((int)pixelWidth, (int)pixelHeight))
						{
	...
	public Vector2 NativeResolution
	{
		get
		{
			return new Vector2(nativeResolutionWidth, nativeResolutionHeight);
		}
	}
	...
	public Vector2 ScreenOffset
	{
		get
		{
			return new Vector2(ScreenExtents.xMin - NativeScreenExtents.xMin, ScreenExtents.yMin - NativeScreenExtents.yMin);
		}
	}
	...
	public Vector2 resolution
	{
		get
		{
			return new Vector2(ScreenExtents.xMax, ScreenExtents.yMax);
		}
	}
	...
	public Vector2 ScaledResolution
	{
		get
		{
			return new Vector2(ScreenExtents.width, ScreenExtents.height);
		}
	}
	...
	public Camera ScreenCamera
	{
		get
		{
			return (!viewportClippingEnabled || !(inheritSettings != null) || !(inheritSettings.UnityCamera.rect == unitRect)) ? UnityCamera : inheritSettings.UnityCamera;
		}
	}
	...
	private void Upgrade()
	{
		...
		Debug.Log("tk2dCamera '" + base.name + "' - Upgraded from version " + version);
	...
	public void UpdateCameraMatrix()
	{
		...
		Matrix4x4 matrix4x = GetProjectionMatrixForOverride(settingsRoot, settingsRoot.CurrentResolutionOverride, _targetResolution.x, _targetResolution.y, true, out _screenExtents, out _nativeScreenExtents);
