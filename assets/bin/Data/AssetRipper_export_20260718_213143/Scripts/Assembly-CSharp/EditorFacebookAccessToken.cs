...
public class EditorFacebookAccessToken : MonoBehaviour
{
	...
	private void OnGUI()
	{
		float top = (float)(Screen.height / 2) - windowHeight / 2f;
		...
		GUI.ModalWindow(GetHashCode(), new Rect(left, top, 592f, windowHeight), OnGUIDialog, "Unity Editor Facebook Login");
	}
