...
public class tk2dSprite : tk2dBaseSprite
{
	...
	[HideInInspector]
	public bool ignoreCustomMaterial;
	...
	protected override void UpdateMaterial()
	{
		...
		else if (base.renderer.sharedMaterial != collectionInst.spriteDefinitions[base.spriteId].materialInst)
		{
			base.renderer.material = collectionInst.spriteDefinitions[base.spriteId].materialInst;
		}
	}
	...
	public override void ReshapeBounds(Vector3 dMin, Vector3 dMax)
	{
		...
		scale = new Vector3(_scale.x * vector4.x, _scale.y * vector4.y, _scale.z);
	}
}
