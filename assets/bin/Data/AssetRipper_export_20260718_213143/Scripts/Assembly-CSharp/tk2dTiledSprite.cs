...
public class tk2dTiledSprite : tk2dBaseSprite
{
	...
	public override void Build()
	{
		...
		{
			Vector3 pMin = new Vector3(currentSprite.positions[0].x * dimensions.x * currentSprite.texelSize.x * scale.x, currentSprite.positions[0].y * dimensions.y * currentSprite.texelSize.y * scale.y);
			Vector3 pMax = new Vector3(currentSprite.positions[3].x * dimensions.x * currentSprite.texelSize.x * scale.x, currentSprite.positions[3].y * dimensions.y * currentSprite.texelSize.y * scale.y);
