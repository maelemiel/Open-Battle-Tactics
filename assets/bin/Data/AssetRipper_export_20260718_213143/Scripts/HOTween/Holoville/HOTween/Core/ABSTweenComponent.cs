...
namespace Holoville.HOTween.Core
{
	public abstract class ABSTweenComponent : IHOTweenComponent
	{
		...
		protected void SetLoops()
		{
			...
			_isLoopingBack = _loopType != LoopType.Restart && _loopType != LoopType.Incremental && ((_loops > 0 && ((_completedLoops < _loops && _completedLoops % 2 != 0) || (_completedLoops >= _loops && _completedLoops % 2 == 0))) || (_loops < 0 && _completedLoops % 2 != 0));
		}
